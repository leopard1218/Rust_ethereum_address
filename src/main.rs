...
async fn main() -> Result<()> {
    ...
    let transaction = eth_wallet::create_eth_transaction(Address::from_str("0x7Ff3A8Ac4dD8458a523bA435310318E13691fd58")?, 0.01);
    let transact_hash = eth_wallet::sign(&web3_con, transaction, &loaded_wallet.get_secret_key()?).await?;
